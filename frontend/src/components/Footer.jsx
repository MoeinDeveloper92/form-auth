...
function Footer() {
    return (
        <footer className="fixed bottom-0 left-0 footer items-center p-4 bg-neutral text-neutral-content">
            <div className="items-center grid-flow-col">
                ...
                <p>MERN Authentication/Copyright © 2023 - All right reserved/Moein Samani Nejad</p>
            </div>
